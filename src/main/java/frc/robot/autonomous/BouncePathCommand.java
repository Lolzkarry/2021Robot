...
public class BouncePathCommand extends SequentialCommandGroup {
    ...
    public BouncePathCommand(OdometricSwerve swerve) {
        ...
        AdvancedSwerveController controllerPart1 = new AdvancedSwerveController(0.1, 0.1, true, 0.15, true, 3, 4, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathComponent1").getStates().toArray(Trajectory.State[]::new));
        controllerPart1.setContinuousRotation();
        AdvancedSwerveController controllerPart2 = new AdvancedSwerveController(0.1, 0.1, true, 0.15, true, 3, 4, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathComponent2").getStates().toArray(Trajectory.State[]::new));
        controllerPart2.setContinuousRotation();
        AdvancedSwerveController controllerPart3 = new AdvancedSwerveController(0.1, 0.1, true, 0.15, true, 3, 4, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathComponent3").getStates().toArray(Trajectory.State[]::new));
        ...
        controllerPart2.setSamplingRate(samplingRate);
        controllerPart3.setSamplingRate(samplingRate);
        controllerPart4.setSamplingRate(samplingRate);
