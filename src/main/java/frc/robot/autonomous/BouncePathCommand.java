...
public class BouncePathCommand extends SequentialCommandGroup {
    ...
    public BouncePathCommand(OdometricSwerve swerve) {
        ...
        AdvancedSwerveController controllerPart1 = new AdvancedSwerveController(0.1, 0.1, true, 0.1, true, 3, 0, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathCommandPart1").getStates().toArray(Trajectory.State[]::new));
        AdvancedSwerveController controllerPart2 = new AdvancedSwerveController(0.1, 0.1, true, 0.1, true, 3, 0, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathCommandPart2").getStates().toArray(Trajectory.State[]::new));
        AdvancedSwerveController controllerPart3 = new AdvancedSwerveController(0.1, 0.1, true, 0.1, true, 3, 0, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathCommandPart3").getStates().toArray(Trajectory.State[]::new));
        AdvancedSwerveController controllerPart4 = new AdvancedSwerveController(0.1, 0.1, true, 0.1, true, 3, 0, new Rotation2d(),2.4,tryGetDeployedTrajectory("BouncePathCommandPart4").getStates().toArray(Trajectory.State[]::new));
