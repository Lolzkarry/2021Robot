...
public class BouncePathCommand extends SequentialCommandGroup {
    ...
    public BouncePathCommand(OdometricSwerve swerve) {
        ...
        Command pathPart1 = addDottedTrajectoryWithShuffleboard(swerve, "Bounce Path", "BouncePathComponent1", true, 0);
        Command pathPart2 = addDottedTrajectoryWithShuffleboard(swerve, "Bounce Path", "BouncePathComponent2", true, Math.PI);
        Command pathPart3 = addDottedTrajectoryWithShuffleboard(swerve, "Bounce Path", "BouncePathComponent3", true, 0);
        Command pathPart4 = addDottedTrajectoryWithShuffleboard(swerve, "Bounce Path", "BouncePathComponent4", true, Math.PI);
